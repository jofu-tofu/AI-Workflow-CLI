...
- [x] Map all capabilities and terminologies between AI editors (e.g., Windsurf "workflow" = Claude Code "command/skill")
- [x] Create a standardized template - either based on Claude Code or a custom standard format
- [x] Document workaround patterns to emulate missing capabilities (e.g., use Windsurf rules to emulate Claude skills via front matter)
- [x] Build programmatic, deterministic mapping system for automation
- [x] Define standardized file structure that works across different AI assistants
- [x] Support 1-2 IDEs/CLI tools initially, then expand
...
See MILESTONE-v1.0.md for complete project summary.
