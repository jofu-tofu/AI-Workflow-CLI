# Core Infrastructure Visual Overview

## Purpose

This document provides a visual and conceptual overview of the AIW CLI core context management infrastructure. This system solves three core problems:
...
- **TypeScript library API:** `.aiwcli/_core/lib-ts/CLAUDE.md`
...
- ✅ Core infrastructure in `.aiwcli/_core/`
...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│  CORE INFRASTRUCTURE: THE BIG PICTURE                                       │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
...
*This document provides the conceptual foundation for the core context management infrastructure. For implementation details, see the full plan document.*
