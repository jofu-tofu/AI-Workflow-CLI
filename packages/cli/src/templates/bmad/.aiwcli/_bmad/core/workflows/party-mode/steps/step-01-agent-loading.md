...
- Agent manifest CSV is available at `{project-root}/.aiwcli/_bmad/_config/agent-manifest.csv`
...
Load and parse the agent manifest CSV from `{project-root}/.aiwcli/_bmad/_config/agent-manifest.csv`
