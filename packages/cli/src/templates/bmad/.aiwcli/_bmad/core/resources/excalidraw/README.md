...
helpers: '{project-root}/.aiwcli/_bmad/core/resources/excalidraw/excalidraw-helpers.md'
json_validation: '{project-root}/.aiwcli/_bmad/core/resources/excalidraw/validate-json-instructions.md'
```
