...
Load, read the full file and then execute `{project-root}/.aiwcli/_bmad/bmm/workflows/1-analysis/create-product-brief/steps/step-01-init.md` to begin the workflow.
