...
<critical>You MUST have already loaded and processed: {project-root}/.aiwcli/_bmad/bmm/workflows/document-project/workflow.yaml</critical>
...
<invoke-workflow path="{project-root}/.aiwcli/_bmad/bmm/workflows/workflow-status">
