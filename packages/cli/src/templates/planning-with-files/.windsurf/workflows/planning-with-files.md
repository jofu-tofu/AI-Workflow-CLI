---
description: Implements Manus-style file-based planning for complex tasks. Creates task_plan.md, findings.md, and progress.md in _planning-with-files-output/. Use when starting complex multi-step tasks, research projects, or any task requiring >5 tool calls.
...
4. Create planning files in the `_planning-with-files-output/` directory (NOT in the skill directory)
...
1. **Create `_planning-with-files-output/task_plan.md`** - Track phases and progress
2. **Create `_planning-with-files-output/findings.md`** - Store research and discoveries
3. **Create `_planning-with-files-output/progress.md`** - Session log and test results
