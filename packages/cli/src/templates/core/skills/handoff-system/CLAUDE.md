...
**Usage:**
```bash
bun .aiwcli/_core/skills/handoff-system/scripts/save_handoff.ts [--context-id ID] [--session-id SID] < handoff.md
```
...
bun .aiwcli/_core/skills/handoff-system/scripts/resume_handoff.ts path/to/handoff/index.md

# Explicit context
bun .aiwcli/_core/skills/handoff-system/scripts/resume_handoff.ts --context context-id
```
...
**Location:** `core/skills/handoff-system/lib/handoff-reader.ts`
...
**Location:** `core/skills/handoff-system/lib/document-generator.ts`
...
→ References `.aiwcli/_core/skills/handoff-system/workflows/handoff.md` (detailed procedural steps)
...
```markdown
See `.aiwcli/_core/skills/handoff-system/workflows/handoff.md` for complete process documentation.
```

## Testing

**Integration test:**
`core/lib-ts/__tests__/integration/handoff-lifecycle.test.ts`
...
echo '{"hook_event_name":"SessionStart","session_id":"test","source":"clear"}' | \
  bun .aiwcli/_core/hooks-ts/session_start.ts
```
...
Both `.aiwcli/_core/skills/handoff-system/` (working copy) and `packages/cli/src/templates/core/skills/handoff-system/` (template source) must stay in sync per CLAUDE.md template sync rules.
...
- Reference from project root: `.aiwcli/_core/skills/handoff-system/scripts/save_handoff.ts`
