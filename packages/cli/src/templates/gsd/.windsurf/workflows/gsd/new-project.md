...
This workflow is defined in detail at `_gsd/workflows/new-project.md`.

**CRITICAL:** Load the FULL content from `@_gsd/workflows/new-project.md`, READ its entire contents, and follow its directions exactly!
