...
This workflow is defined in detail at `.aiwcli/_gsd/workflows/plan-phase.md`.

**CRITICAL:** Load the FULL content from `@.aiwcli/_gsd/workflows/plan-phase.md`, READ its entire contents, and follow its directions exactly!
